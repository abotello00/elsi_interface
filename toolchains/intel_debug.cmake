...
SET(ENABLE_BSEPACK OFF CACHE BOOL "Enable BSEPACK")
...
SET(LIB_PATHS "$ENV{MKLROOT}/lib/intel64 $ENV{ELPA_ROOT}/lib $ENV{OMM_ROOT}/lib $ENV{MatrixSwitch_ROOT}/lib $ENV{PEXSI_ROOT}/lib  $ENV{SUPERLU_DIST_ROOT}/lib $ENV{SCOTCH_ROOT}/lib $ENV{NTPOLY_ROOT}/lib" CACHE STRING "External library paths")
SET(INC_PATHS "$ENV{ELPA_ROOT}/include $ENV{OMM_ROOT}/include $ENV{PEXSI_ROOT}/include $ENV{PEXSI_ROOT}/include/pexsi $ENV{SUPERLU_DIST_ROOT}/include $ENV{SCOTCH_ROOT}/include $ENV{NTPOLY_ROOT}/include" CACHE STRING "External library include paths")
SET(LIBS "OMM MatrixSwitch elpa pexsi superlu_dist ptscotchparmetisv3 ptscotch ptscotcherr scotchmetisv3 scotch scotcherr NTPoly sseig mkl_scalapack_lp64 mkl_blacs_intelmpi_lp64 mkl_intel_lp64 mkl_sequential mkl_core" CACHE STRING "External libraries")
