...
!#endif 
  ...
  ! have to point ev
   ...
   if (.not.(obj%eigenvalues_only)) then
     ...
     call check_allocate_f("elpa1_template: q_dummy", 638,  istat,  errorMessage)
     q_actual => q_dummy
   endif

   allocate(e(na), tau(na), stat=istat, errmsg=errorMessage)
   call check_allocate_f("elpa1_template: e, tau", 652,  istat,  errorMessage)
...
!        global_index = indxl2g(i, nblk, my_prow, 0, np_rows)
   ...
   call check_deallocate_f("elpa1_template: e, tau", 854,  istat,  errorMessage)

   if (obj%eigenvalues_only) then
     deallocate(q_dummy, stat=istat, errmsg=errorMessage)
     call check_deallocate_f("elpa1_template: q_dummy", 858,  istat,  errorMessage)
   endif
   ...
   call check_deallocate_f("elpa1_template: e", 958,  istat,  errorMessage)
...
!#endif 
  ...
  real(kind=rck), pointer                                   :: q(:,:)
   ...
   call check_allocate_f("elpa1_template: aIntern", 442,  istat,  errorMessage)

   a       => aIntern(1:matrixRows,1:matrixCols)

   allocate(evIntern(1:obj%na), stat=istat, errmsg=errorMessage)
   call check_allocate_f("elpa1_template: evIntern", 447,  istat,  errorMessage)
   ev      => evIntern(1:obj%na)

   if (present(qExtern)) then
     allocate(qIntern(1:matrixRows,1:matrixCols), stat=istat, errmsg=errorMessage)
     call check_allocate_f("elpa1_template: qIntern", 456,  istat,  errorMessage)
   endif
...
!        global_index = indxl2g(i, nblk, my_prow, 0, np_rows)
   ...
   ! restore original OpenMP settings
     ...
     call check_deallocate_f("elpa1_template: aIntern", 930,  istat,  errorMessage)
     !deallocate(evIntern)
     nullify(evIntern)
     if (present(qExtern)) then
       deallocate(qIntern, stat=istat, errmsg=errorMessage)
       call check_deallocate_f("elpa1_template: qIntern", 935,  istat,  errorMessage)
     endif
...
!#endif 
  ...
  ! have to point ev
   ...
   call check_allocate_f("elpa1_template: q_real", 649,  istat,  errorMessage)
   allocate(e(na), tau(na), stat=istat, errmsg=errorMessage)
   call check_allocate_f("elpa1_template: e, tau", 652,  istat,  errorMessage)
...
!        global_index = indxl2g(i, nblk, my_prow, 0, np_rows)
    ...
    call check_deallocate_f("elpa1_template: q_real", 850,  istat,  errorMessage)
...
!#endif 
  ...
  real(kind=rck), pointer                                   :: q(:,:)
   ...
   if (present(qExtern)) then
     ...
     call check_allocate_f("elpa1_template: qIntern", 453,  istat,  errorMessage)
   endif
